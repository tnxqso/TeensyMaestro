...
#define SLICE_SQUELCH_LEVEL 6016
...
class Slice
{
  public:
	...
	void set_index_letter(String newval);
	void set_RF_frequency(long newval); 
	...
	void set_squelch(int newval); 
	void set_squelch_level(int newval); 
	...
	void attach_index_letter_event(eventHandlerArrFunction _eventHandler);
	...
	void attach_squelch_event(eventHandlerArrFunction _eventHandler); 
	void attach_squelch_level_event(eventHandlerArrFunction _eventHandler); 
  ...
  private:
	...
	//event handlers
    	...
    	eventHandlerArrFunction do_index_letter_event=NULL;
	...
	eventHandlerArrFunction do_squelch_event=NULL; 
	eventHandlerArrFunction do_squelch_level_event=NULL; 
