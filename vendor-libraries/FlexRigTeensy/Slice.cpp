...
FLASHMEM void Slice::updateStatus(String msg) {
...
// ===== [TM STEP1] Slice::setValue (pan fixed, lightweight) =====
FLASHMEM void Slice::setValue(String msg) {
    int i = msg.indexOf('=');
    if (i <= 0) return;

    String var = msg.substring(0, i);

    // --- FIX: correct, heap-free parsing of pan handles (supports 0x... and decimal)
    if (var.equals(F("pan"))) {
        const char* raw = msg.c_str() + i + 1;           // borrow pointer; no allocation
        const uint32_t handle = tm_parse_hex32(raw);
		tm_print_hex32(handle);

        if (handle != 0u) {
            set_pan((int)handle);                        // on Teensy int is 32-bit; safe for 0x40000000
        }
        return;
    }

    // --- Unchanged handlers (keep lightweight conversions) ---
    if (var.equals(F("in_use")))           { set_in_use(msg.substring(i + 1).toInt()); return; }
    if (var.equals(F("index_letter")))     { set_index_letter(msg.substring(i + 1)); return; }
    if (var.equals(F("RF_frequency")))     { set_RF_frequency(msg.substring(i + 1).toFloat() * 1000000.0f); return; }
    ...
    if (var.equals(F("filter_lo")))        { set_filter_lo(msg.substring(i + 1).toInt()); calcShiftWidthValue(); return; }
    if (var.equals(F("filter_hi")))        { set_filter_hi(msg.substring(i + 1).toInt()); calcShiftWidthValue(); return; }
    ...
    // (old buggy) if (var.equals(F("pan"))) { set_pan(msg.substring(i+3).toInt()); return; }
    ...
    if (var.equals(F("squelch")))          { set_squelch(msg.substring(i + 1).toInt()); return; }
    if (var.equals(F("squelch_level")))    { set_squelch_level(msg.substring(i + 1).toInt()); return; }
...
FLASHMEM void Slice::set_sliceId(int newval) {
	sliceId=newval;
}

FLASHMEM void Slice::set_in_use(int newval) {
	if (newval!=in_use) {
		in_use=newval;
		upd_in_use=true;
	}
...
FLASHMEM void Slice::set_index_letter(String newval) {
	if (newval!=index_letter) {
		index_letter=newval;
		upd_index_letter=true;
	}
}

FLASHMEM void Slice::set_RF_frequency(long newval) {
...
FLASHMEM void Slice::set_rit_on(int newval) {
	if (newval!=rit_on) {
		rit_on=newval;
		upd_rit_on=true;
	}
...
FLASHMEM void Slice::set_rit_freq(int newval) {
	if (newval!=rit_freq) {
		rit_freq=newval;
		upd_rit_freq=true;
	}
...
FLASHMEM void Slice::set_xit_on(int newval) {
	if (newval!=xit_on) {
		xit_on=newval;
		upd_xit_on=true;
	}
...
FLASHMEM void Slice::set_xit_freq(int newval) {
	if (newval!=xit_freq) {
		xit_freq=newval;
		upd_xit_freq=true;
	}
...
FLASHMEM void Slice::set_wide(int newval) {
	if (newval!=wide) {
		wide=newval;
		upd_wide=true;
	}
...
FLASHMEM void Slice::set_filter_lo(int newval) {
	if (newval!=filter_lo) {
		filter_lo=newval;
		upd_filter_lo=true;
	}
...
FLASHMEM void Slice::set_filter_hi(int newval) {
	if (newval!=filter_hi) {
		filter_hi=newval;
		upd_filter_hi=true;
	}
...
FLASHMEM void Slice::set_step(int newval) {
    if (newval!=step) {
		step=newval;
		upd_step=true;
	}
...
FLASHMEM void Slice::set_agc_threshold(int newval) {
...
FLASHMEM void Slice::set_agc_off_level(int newval) {
...
FLASHMEM void Slice::set_pan(int newval) {
	if (newval!=pan) {
		pan=newval;
		upd_pan=true;
	}
...
FLASHMEM void Slice::set_loopa(int newval) {
	if (newval!=loopa) {
		loopa=newval;
		upd_loopa=true;
	}
...
FLASHMEM void Slice::set_loopb(int newval) {
	if (newval!=loopb) {
		loopb=newval;
		upd_loopb=true;
	}
...
FLASHMEM void Slice::set_qsk(int newval) {
	if (newval!=qsk) {
		qsk=newval;
		upd_qsk=true;
	}
...
FLASHMEM void Slice::set_dax(int newval) {
	if (newval!=dax) {
		dax=newval;
		upd_dax=true;
	}
...
FLASHMEM void Slice::set_dax_clients(int newval) {
...
FLASHMEM void Slice::set_lock(int newval) {
	if (newval!=lock) {
		lock=newval;
		upd_lock=true;
	}
...
FLASHMEM void Slice::set_tx(int newval) {
	if (newval!=tx) {
		tx=newval;
		upd_tx=true;
	}
...
FLASHMEM void Slice::set_dax_tx(int newval) {
	if (newval!=dax_tx) {
		dax_tx=newval;
		upd_dax_tx=true;
	}
...
FLASHMEM void Slice::set_active(int newval) {
	if (newval!=active) {
		active=newval;
		upd_active=true;
	}
...
FLASHMEM void Slice::set_audio_gain(int newval) {
...
FLASHMEM void Slice::set_audio_pan(int newval) {
	if (newval!=audio_pan) {
		audio_pan=newval;
		upd_audio_pan=true;
	}
...
FLASHMEM void Slice::set_audio_mute(int newval) {
...
FLASHMEM void Slice::set_record(int newval) {
	if (newval!=record) {
		record=newval;
		upd_record=true;
	}
...
FLASHMEM void Slice::set_record_time(int newval) {
...
FLASHMEM void Slice::set_anf(int newval) {
	if (newval!=anf) {
		anf=newval;
		upd_anf=true;
	}
...
FLASHMEM void Slice::set_anf_level(int newval) {
	if (newval!=anf_level) {
		anf_level=newval;
		upd_anf_level=true;
	}
...
FLASHMEM void Slice::set_nr(int newval) {
	if (newval!=nr) {
		nr=newval;
		upd_nr=true;
	}
...
FLASHMEM void Slice::set_nr_level(int newval) {
	if (newval!=nr_level) {
		nr_level=newval;
		upd_nr_level=true;
	}
...
FLASHMEM void Slice::set_nb(int newval) {
	if (newval!=nb) {
		nb=newval;
		upd_nb=true;
	}
...
FLASHMEM void Slice::set_nb_level(int newval) {
	if (newval!=nb_level) {
		nb_level=newval;
		upd_nb_level=true;
	}
...
FLASHMEM void Slice::set_wnb(int newval) {
	if (newval!=wnb) {
		wnb=newval;
		upd_wnb=true;
	}
...
FLASHMEM void Slice::set_wnb_level(int newval) {
	if (newval!=wnb_level) {
		wnb_level=newval;
		upd_wnb_level=true;
	}
...
FLASHMEM void Slice::set_apf(int newval) {
	if (newval!=apf) {
		apf=newval;
		upd_apf=true;
	}
...
FLASHMEM void Slice::set_apf_level(int newval) {
	if (newval!=apf_level) {
		apf_level=newval;
		upd_apf_level=true;
	}
...
FLASHMEM void Slice::set_squelch(int newval) {
	if (newval!=squelch) {
		squelch=newval;
		upd_squelch=true;
	}
...
FLASHMEM void Slice::set_squelch_level(int newval) {
	if (newval!=squelch_level) {
		squelch_level=newval;
		upd_squelch_level=true;
	}
}


FLASHMEM void Slice::set_diversity(int newval) {
	if (newval!=diversity) {
		diversity=newval;
		upd_diversity=true;
	}
...
FLASHMEM void Slice::set_diversity_parent(int newval) {
...
FLASHMEM void Slice::set_diversity_child(int newval) {
...
FLASHMEM void Slice::set_diversity_index(int newval) {
...
FLASHMEM void Slice::set_filter_shift(int newval) {
...
FLASHMEM void Slice::set_filter_width(int newval) {
...
FLASHMEM void Slice::set_rxant(String newval) {
...
FLASHMEM void Slice::set_mode(String newval) {
...
FLASHMEM void Slice::set_step_list(String newval) {
...
FLASHMEM void Slice::set_agc_mode(String newval) {
...
FLASHMEM void Slice::set_txant(String newval) {
...
FLASHMEM void Slice::set_play(String newval) {
...
FLASHMEM void Slice::set_ant_list(String newval) {
...
FLASHMEM void Slice::fireEvents() {
	...
	*/
	...
	if ((upd_index_letter) && (do_index_letter_event!=NULL)) {
		do_index_letter_event(sliceId); 
		upd_index_letter=false; 
	}
	...
	if ((upd_squelch) && (do_squelch_event!=NULL)) {
			do_squelch_event(sliceId); 
			upd_squelch=false; 
	}
	
	if ((upd_squelch_level) && (do_squelch_level_event!=NULL)) {
			do_squelch_level_event(sliceId); 
			upd_squelch_level=false; 
	}
...
FLASHMEM void Slice::attach_in_use_event(eventHandlerArrFunction _eventHandler) {
	do_in_use_event=_eventHandler;
}

FLASHMEM void Slice::attach_index_letter_event(eventHandlerArrFunction _eventHandler) {
	do_index_letter_event=_eventHandler;
}

FLASHMEM void Slice::attach_RF_frequency_event(eventHandlerArrFunction _eventHandler) {
	do_RF_frequency_event=_eventHandler;
}

FLASHMEM void Slice::attach_rit_on_event(eventHandlerArrFunction _eventHandler) {
	do_rit_on_event=_eventHandler;
}

FLASHMEM void Slice::attach_rit_freq_event(eventHandlerArrFunction _eventHandler) {
	do_rit_freq_event=_eventHandler;
}

FLASHMEM void Slice::attach_xit_on_event(eventHandlerArrFunction _eventHandler) {
	do_xit_on_event=_eventHandler;
}

FLASHMEM void Slice::attach_xit_freq_event(eventHandlerArrFunction _eventHandler) {
	do_xit_freq_event=_eventHandler;
}

FLASHMEM void Slice::attach_wide_event(eventHandlerArrFunction _eventHandler) {
	do_wide_event=_eventHandler;
}

FLASHMEM void Slice::attach_filter_lo_event(eventHandlerArrFunction _eventHandler) {
	do_filter_lo_event=_eventHandler;
}

FLASHMEM void Slice::attach_filter_hi_event(eventHandlerArrFunction _eventHandler) {
	do_filter_hi_event=_eventHandler;
}

FLASHMEM void Slice::attach_step_event(eventHandlerArrFunction _eventHandler) {
	do_step_event=_eventHandler;
}

FLASHMEM void Slice::attach_agc_threshold_event(eventHandlerArrFunction _eventHandler) {
	do_agc_threshold_event=_eventHandler;
}

FLASHMEM void Slice::attach_agc_off_level_event(eventHandlerArrFunction _eventHandler) {
	do_agc_off_level_event=_eventHandler;
}

FLASHMEM void Slice::attach_pan_event(eventHandlerArrFunction _eventHandler) {
	do_pan_event=_eventHandler;
}

FLASHMEM void Slice::attach_loopa_event(eventHandlerArrFunction _eventHandler) {
	do_loopa_event=_eventHandler;
}

FLASHMEM void Slice::attach_loopb_event(eventHandlerArrFunction _eventHandler) {
	do_loopb_event=_eventHandler;
}

FLASHMEM void Slice::attach_qsk_event(eventHandlerArrFunction _eventHandler) {
	do_qsk_event=_eventHandler;
}

FLASHMEM void Slice::attach_dax_event(eventHandlerArrFunction _eventHandler) {
	do_dax_event=_eventHandler;
}

FLASHMEM void Slice::attach_dax_clients_event(eventHandlerArrFunction _eventHandler) {
	do_dax_clients_event=_eventHandler;
}

FLASHMEM void Slice::attach_lock_event(eventHandlerArrFunction _eventHandler) {
	do_lock_event=_eventHandler;
}

FLASHMEM void Slice::attach_tx_event(eventHandlerArrFunction _eventHandler) {
	do_tx_event=_eventHandler;
}

FLASHMEM void Slice::attach_dax_tx_event(eventHandlerArrFunction _eventHandler) {
	do_dax_tx_event=_eventHandler;
}

FLASHMEM void Slice::attach_active_event(eventHandlerArrFunction _eventHandler) {
	do_active_event=_eventHandler;
}

FLASHMEM void Slice::attach_audio_gain_event(eventHandlerArrFunction _eventHandler) {
	do_audio_gain_event=_eventHandler;
}

FLASHMEM void Slice::attach_audio_pan_event(eventHandlerArrFunction _eventHandler) {
	do_audio_pan_event=_eventHandler;
}

FLASHMEM void Slice::attach_audio_mute_event(eventHandlerArrFunction _eventHandler) {
	do_audio_mute_event=_eventHandler;
}

FLASHMEM void Slice::attach_record_event(eventHandlerArrFunction _eventHandler) {
	do_record_event=_eventHandler;
}

FLASHMEM void Slice::attach_record_time_event(eventHandlerArrFunction _eventHandler) {
	do_record_time_event=_eventHandler;
}

FLASHMEM void Slice::attach_anf_event(eventHandlerArrFunction _eventHandler) {
	do_anf_event=_eventHandler;
}

FLASHMEM void Slice::attach_anf_level_event(eventHandlerArrFunction _eventHandler) {
	do_anf_level_event=_eventHandler;
}

FLASHMEM void Slice::attach_nr_event(eventHandlerArrFunction _eventHandler) {
	do_nr_event=_eventHandler;
}

FLASHMEM void Slice::attach_nr_level_event(eventHandlerArrFunction _eventHandler) {
	do_nr_level_event=_eventHandler;
}

FLASHMEM void Slice::attach_nb_event(eventHandlerArrFunction _eventHandler) {
	do_nb_event=_eventHandler;
}

FLASHMEM void Slice::attach_nb_level_event(eventHandlerArrFunction _eventHandler) {
	do_nb_level_event=_eventHandler;
}

FLASHMEM void Slice::attach_wnb_event(eventHandlerArrFunction _eventHandler) {
	do_wnb_event=_eventHandler;
}

FLASHMEM void Slice::attach_wnb_level_event(eventHandlerArrFunction _eventHandler) {
	do_wnb_level_event=_eventHandler;
}

FLASHMEM void Slice::attach_apf_event(eventHandlerArrFunction _eventHandler) {
	do_apf_event=_eventHandler;
}

FLASHMEM void Slice::attach_apf_level_event(eventHandlerArrFunction _eventHandler) {
	do_apf_level_event=_eventHandler;
}

FLASHMEM void Slice::attach_squelch_event(eventHandlerArrFunction _eventHandler) {
	do_squelch_event=_eventHandler;
}

FLASHMEM void Slice::attach_squelch_level_event(eventHandlerArrFunction _eventHandler) {
	do_squelch_level_event=_eventHandler;
}

FLASHMEM void Slice::attach_diversity_event(eventHandlerArrFunction _eventHandler) {
	do_diversity_event=_eventHandler;
}

FLASHMEM void Slice::attach_diversity_parent_event(eventHandlerArrFunction _eventHandler) {
	do_diversity_parent_event=_eventHandler;
}

FLASHMEM void Slice::attach_diversity_child_event(eventHandlerArrFunction _eventHandler) {
	do_diversity_child_event=_eventHandler;
}

FLASHMEM void Slice::attach_diversity_index_event(eventHandlerArrFunction _eventHandler) {
	do_diversity_index_event=_eventHandler;
}

FLASHMEM void Slice::attach_filter_shift_event(eventHandlerArrFunction _eventHandler) {
	do_filter_shift_event=_eventHandler;
}

FLASHMEM void Slice::attach_filter_width_event(eventHandlerArrFunction _eventHandler) {
	do_filter_width_event=_eventHandler;
}

FLASHMEM void Slice::attach_rxant_event(eventHandlerArrFunction _eventHandler) {
	do_rxant_event=_eventHandler;
}

FLASHMEM void Slice::attach_mode_event(eventHandlerArrFunction _eventHandler) {
	do_mode_event=_eventHandler;
}

FLASHMEM void Slice::attach_step_list_event(eventHandlerArrFunction _eventHandler) {
	do_step_list_event=_eventHandler;
}

FLASHMEM void Slice::attach_agc_mode_event(eventHandlerArrFunction _eventHandler) {
	do_agc_mode_event=_eventHandler;
}

FLASHMEM void Slice::attach_txant_event(eventHandlerArrFunction _eventHandler) {
	do_txant_event=_eventHandler;
}

FLASHMEM void Slice::attach_play_event(eventHandlerArrFunction _eventHandler) {
	do_play_event=_eventHandler;
}

FLASHMEM void Slice::attach_ant_list_event(eventHandlerArrFunction _eventHandler) {
	do_ant_list_event=_eventHandler;
}


FLASHMEM void Slice::updateObject(int objectId,int value){
    switch(objectId) {
...
String Slice::getAgcTMode(){
    ...
    // Use size_t to match String::length()'s unsigned return type
    // Cast to unsigned char before toupper to avoid UB on chars with high bit set
    size_t n = s.length();
...
/*
FLASHMEM void Slice::setFilterLow(int value) {
...
/*
FLASHMEM void Slice::setFilterHigh(int value) {
...
String Slice::getFilterWidthStr() {
    char res[20]; // extra headroom for "%d " / "%.1fK " + NUL
    res[0] = '\0';

    if (filter_width < 1000) {
        // " 123 " (space-padded) fits easily
        snprintf(res, sizeof(res), "%4d ", filter_width);
    } else if (filter_width < 10000) {
        // 1.0K .. 9.9K + space
        float kHz = filter_width / 1000.0f;
        snprintf(res, sizeof(res), "%.1fK ", kHz);
    } else {
        // 10.0K .. uppåt (vi visar en decimal)
        float kHz = filter_width / 1000.0f;
        snprintf(res, sizeof(res), "%.1fK", kHz);
    }
