...
FLASHMEM void Panadapter::updateStatus(String msg) {
...
FLASHMEM void Panadapter::setValue(String msg){
	int i=msg.indexOf('=');
	if (i>0) {
...
FLASHMEM void Panadapter::set_pan(int newval) {
    if (newval!=pan) {
		pan=newval;
		upd_pan=true;
	}
...
FLASHMEM void Panadapter::set_x_pixels(int newval) {
	if (newval!=x_pixels) {
		x_pixels=newval;
		upd_x_pixels=true;
	}
...
FLASHMEM void Panadapter::set_y_pixels(int newval) {
	if (newval!=y_pixels) {
		y_pixels=newval;
		upd_y_pixels=true;
	}
...
FLASHMEM void Panadapter::set_min_dbm(int newval) {
	if (newval!=min_dbm) {
		min_dbm=newval;
		upd_min_dbm=true;
	}
...
FLASHMEM void Panadapter::set_max_dbm(int newval) {
	if (newval!=max_dbm) {
		max_dbm=newval;
		upd_max_dbm=true;
	}
...
FLASHMEM void Panadapter::set_fps(int newval) {
	if (newval!=fps) {
		fps=newval;
		upd_fps=true;
	}
...
FLASHMEM void Panadapter::set_average(int newval) {
	if (newval!=average) {
		average=newval;
		upd_average=true;
	}
...
FLASHMEM void Panadapter::set_weighted_average(int newval) {
...
FLASHMEM void Panadapter::set_rfgain(int newval) {
	if (newval!=rfgain) {
		rfgain=newval;
		upd_rfgain=true;
	}
...
FLASHMEM void Panadapter::set_wide(int newval) {
	if (newval!=wide) {
		wide=newval;
		upd_wide=true;
	}
...
FLASHMEM void Panadapter::set_loopa(int newval) {
	if (newval!=loopa) {
		loopa=newval;
		upd_loopa=true;
	}
...
FLASHMEM void Panadapter::set_loopb(int newval) {
	if (newval!=loopb) {
		loopb=newval;
		upd_loopb=true;
	}
...
FLASHMEM void Panadapter::set_band(int newval) {
	if (newval!=band) {
		previousBand=band;
		band=newval;
		upd_band=true;
...
FLASHMEM void Panadapter::set_daxiq(int newval) {
	if (newval!=daxiq) {
		daxiq=newval;
		upd_daxiq=true;
	}
...
FLASHMEM void Panadapter::set_daxiq_rate(int newval) {
...
FLASHMEM void Panadapter::set_capacity(int newval) {
	if (newval!=capacity) {
		capacity=newval;
		upd_capacity=true;
	}
...
FLASHMEM void Panadapter::set_available(int newval) {
	if (newval!=available) {
		available=newval;
		upd_available=true;
	}
...
FLASHMEM void Panadapter::set_waterfall(int newval) {
	if (newval!=waterfall) {
		waterfall=newval;
		upd_waterfall=true;
	}
...
FLASHMEM void Panadapter::set_xvtr(int newval) {
	if (newval!=xvtr) {
		xvtr=newval;
		upd_xvtr=true;
	}
...
FLASHMEM void Panadapter::set_pre(int newval) {
	if (newval!=pre) {
		pre=newval;
		upd_pre=true;
	}
...
FLASHMEM void Panadapter::set_min_bw(float newval) {
	if (newval!=min_bw) {
		min_bw=newval;
		upd_min_bw=true;
	}
...
FLASHMEM void Panadapter::set_max_bw(float newval) {
	if (newval!=max_bw) {
		max_bw=newval;
		upd_max_bw=true;
	}
...
FLASHMEM void Panadapter::set_bandwidth(float newval) {
	if (newval!=bandwidth) {
		bandwidth=newval;
		upd_bandwidth=true;
	}
...
FLASHMEM void Panadapter::set_center(float newval) 
//FLASHMEM void Panadapter::set_center(double newval)
{
	if (newval!=center) {
		center=newval;
		upd_center=true;
...
FLASHMEM void Panadapter::set_ant_list(String newval) {
...
FLASHMEM void Panadapter::set_rxant(String newval) {
...
FLASHMEM void Panadapter::set_wnb_updating(int newval) {
...
FLASHMEM void Panadapter::set_wnb(int newval) {
	if (newval!=wnb) {
		wnb=newval;
		upd_wnb=true;
	}
...
FLASHMEM void Panadapter::set_wnb_level(int newval) {
	if (newval!=wnb_level) {
		wnb_level=newval;
		upd_wnb_level=true;
	}
...
FLASHMEM void Panadapter::set_spot_triggered(int newval) {
...
FLASHMEM void Panadapter::fireEvents() {
	...
	*/
	...
	if ((upd_spot_triggered) && (do_spot_triggered_event!=NULL)) {
			do_spot_triggered_event(pan); 
			upd_spot_triggered=false; 
	}

}

FLASHMEM void Panadapter::attach_pan_event(eventHandlerArrFunction _eventHandler) {
	do_pan_event=_eventHandler;
}


FLASHMEM void Panadapter::attach_x_pixels_event(eventHandlerArrFunction _eventHandler) {
	do_x_pixels_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_y_pixels_event(eventHandlerArrFunction _eventHandler) {
	do_y_pixels_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_min_dbm_event(eventHandlerArrFunction _eventHandler) {
	do_min_dbm_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_max_dbm_event(eventHandlerArrFunction _eventHandler) {
	do_max_dbm_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_fps_event(eventHandlerArrFunction _eventHandler) {
	do_fps_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_average_event(eventHandlerArrFunction _eventHandler) {
	do_average_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_weighted_average_event(eventHandlerArrFunction _eventHandler) {
	do_weighted_average_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_rfgain_event(eventHandlerArrFunction _eventHandler) {
	do_rfgain_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_wide_event(eventHandlerArrFunction _eventHandler) {
	do_wide_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_loopa_event(eventHandlerArrFunction _eventHandler) {
	do_loopa_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_loopb_event(eventHandlerArrFunction _eventHandler) {
	do_loopb_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_band_event(eventHandlerArrFunction _eventHandler) {
	do_band_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_daxiq_event(eventHandlerArrFunction _eventHandler) {
	do_daxiq_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_daxiq_rate_event(eventHandlerArrFunction _eventHandler) {
	do_daxiq_rate_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_capacity_event(eventHandlerArrFunction _eventHandler) {
	do_capacity_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_available_event(eventHandlerArrFunction _eventHandler) {
	do_available_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_waterfall_event(eventHandlerArrFunction _eventHandler) {
	do_waterfall_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_xvtr_event(eventHandlerArrFunction _eventHandler) {
	do_xvtr_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_pre_event(eventHandlerArrFunction _eventHandler) {
	do_pre_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_min_bw_event(eventHandlerArrFunction _eventHandler) {
	do_min_bw_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_max_bw_event(eventHandlerArrFunction _eventHandler) {
	do_max_bw_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_bandwidth_event(eventHandlerArrFunction _eventHandler) {
	do_bandwidth_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_center_event(eventHandlerArrFunction _eventHandler) {
	do_center_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_ant_list_event(eventHandlerArrFunction _eventHandler) {
	do_ant_list_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_rxant_event(eventHandlerArrFunction _eventHandler) {
	do_rxant_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_wnb_updating_event(eventHandlerArrFunction _eventHandler) {
	do_wnb_updating_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_wnb_event(eventHandlerArrFunction _eventHandler) {
	do_wnb_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_wnb_level_event(eventHandlerArrFunction _eventHandler) {
	do_wnb_level_event=_eventHandler;
}

FLASHMEM void Panadapter::attach_spot_triggered_event(eventHandlerArrFunction _eventHandler) {
	do_spot_triggered_event=_eventHandler;
}

FLASHMEM void Panadapter::updateObject(int objectId,int value){
