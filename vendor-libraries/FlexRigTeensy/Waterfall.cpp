...
FLASHMEM void Waterfall::updateStatus(String msg) {
	//Serial.println(msg);
	updated=true;
	int oldi=0;
...
FLASHMEM void Waterfall::setValue(String msg){
	int i=msg.indexOf('=');
	if (i>0) {
...
FLASHMEM void Waterfall::set_waterfall(int newval) {
	if (newval!=waterfall) {
		waterfall=newval;
		upd_waterfall=true;
	}
...
FLASHMEM void Waterfall::set_x_pixels(int newval) {
	if (newval!=x_pixels) {
		x_pixels=newval;
		upd_x_pixels=true;
	}
...
FLASHMEM void Waterfall::set_center(float newval) {
	if (newval!=center) {
		center=newval;
		upd_center=true;
	}
...
FLASHMEM void Waterfall::set_bandwidth(float newval) {
	if (newval!=bandwidth) {
		bandwidth=newval;
		upd_bandwidth=true;
	}
...
FLASHMEM void Waterfall::set_line_duration(int newval) {
...
FLASHMEM void Waterfall::set_rfgain(int newval) {
	if (newval!=rfgain) {
		rfgain=newval;
		upd_rfgain=true;
	}
...
FLASHMEM void Waterfall::set_rxant(String newval) {
...
FLASHMEM void Waterfall::set_wide(int newval) {
	if (newval!=wide) {
		wide=newval;
		upd_wide=true;
	}
...
FLASHMEM void Waterfall::set_loopa(int newval) {
	if (newval!=loopa) {
		loopa=newval;
		upd_loopa=true;
	}
...
FLASHMEM void Waterfall::set_loopb(int newval) {
	if (newval!=loopb) {
		loopb=newval;
		upd_loopb=true;
	}
...
FLASHMEM void Waterfall::set_band(int newval) {
	if (newval!=band) {
		band=newval;
		upd_band=true;
	}
...
FLASHMEM void Waterfall::set_daxiq(int newval) {
	if (newval!=daxiq) {
		daxiq=newval;
		upd_daxiq=true;
	}
...
FLASHMEM void Waterfall::set_daxiq_rate(int newval) {
...
FLASHMEM void Waterfall::set_capacity(int newval) {
	if (newval!=capacity) {
		capacity=newval;
		upd_capacity=true;
	}
...
FLASHMEM void Waterfall::set_available(int newval) {
	if (newval!=available) {
		available=newval;
		upd_available=true;
	}
...
FLASHMEM void Waterfall::set_panadapter(int newval) {
...
FLASHMEM void Waterfall::set_color_gain(int newval) {
...
FLASHMEM void Waterfall::set_auto_black(int newval) {
...
FLASHMEM void Waterfall::set_black_level(int newval) {
...
FLASHMEM void Waterfall::set_gradient_index(int newval) {
...
FLASHMEM void Waterfall::set_xvtr(int newval) {
	if (newval!=xvtr) {
		xvtr=newval;
		upd_xvtr=true;
	}
...
FLASHMEM void Waterfall::fireEvents() {
...
FLASHMEM void Waterfall::attach_waterfall_event(eventHandlerArrFunction _eventHandler) {
	do_waterfall_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_x_pixels_event(eventHandlerArrFunction _eventHandler) {
	do_x_pixels_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_center_event(eventHandlerArrFunction _eventHandler) {
	do_center_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_bandwidth_event(eventHandlerArrFunction _eventHandler) {
	do_bandwidth_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_line_duration_event(eventHandlerArrFunction _eventHandler) {
	do_line_duration_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_rfgain_event(eventHandlerArrFunction _eventHandler) {
	do_rfgain_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_rxant_event(eventHandlerArrFunction _eventHandler) {
	do_rxant_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_wide_event(eventHandlerArrFunction _eventHandler) {
	do_wide_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_loopa_event(eventHandlerArrFunction _eventHandler) {
	do_loopa_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_loopb_event(eventHandlerArrFunction _eventHandler) {
	do_loopb_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_band_event(eventHandlerArrFunction _eventHandler) {
	do_band_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_daxiq_event(eventHandlerArrFunction _eventHandler) {
	do_daxiq_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_daxiq_rate_event(eventHandlerArrFunction _eventHandler) {
	do_daxiq_rate_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_capacity_event(eventHandlerArrFunction _eventHandler) {
	do_capacity_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_available_event(eventHandlerArrFunction _eventHandler) {
	do_available_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_panadapter_event(eventHandlerArrFunction _eventHandler) {
	do_panadapter_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_color_gain_event(eventHandlerArrFunction _eventHandler) {
	do_color_gain_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_auto_black_event(eventHandlerArrFunction _eventHandler) {
	do_auto_black_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_black_level_event(eventHandlerArrFunction _eventHandler) {
	do_black_level_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_gradient_index_event(eventHandlerArrFunction _eventHandler) {
	do_gradient_index_event=_eventHandler;
}

FLASHMEM void Waterfall::attach_xvtr_event(eventHandlerArrFunction _eventHandler) {
	do_xvtr_event=_eventHandler;
}


FLASHMEM void Waterfall::updateObject(int objectId,int value){
	switch(objectId) {
