...
namespace TM_RCS {
  // Initialize the remote command server based on CFG_RCS_Enable / CFG_RCS_TCP_Port.
  void begin();

  // Poll for incoming TCP connections and process at most one client at a time.
  void poll();
}
